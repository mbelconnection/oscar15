...
%> <xml id="xml_list"> <planner> <%= risk_content %> <%= checklist_content %>
        ...
        StringBuffer tt;
        System.out.println("jsp :" + oscarVariables.getProperty("tomcat_path") +"webapps/"+ oscarVariables.getProperty("project_home") + "/decision/annualreview/desannualreviewplannerrisk.xml");
