...
INSERT INTO PROVIDER VALUES ('999997','oscaradmin','admin','admin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL);
INSERT INTO PROVIDER VALUES ('999998','oscardoc','doctor','doctor',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL);
INSERT INTO PROVIDER VALUES ('999999','oscarrep','receptionist','receptionist',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL);
INSERT INTO PROVIDER VALUES ('88888','Support','IT','receptionist',NULL,'Admin',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL);
INSERT INTO PROVIDER VALUES ('174','Chan','David','doctor','Family Medicine','TEAM A','M',NULL,NULL,'H 905-','058081',NULL,NULL,'BAAP','1','1',NULL,NULL);
...
ID NUMBER(10),
DEMOGRAPHIC_NO NUMBER(10) ,
RELATION_DEMOGRAPHIC_NO NUMBER(10),
RELATION VARCHAR(20),
CREATION_DATE DATE ,
CREATOR VARCHAR(6),
...
CREATE INDEX RELATIONSHIPS_DEMOGRAPHIC_NO ON RELATIONSHIPS(DEMOGRAPHIC_NO);
CREATE INDEX RELATIONSHIPS_RELATION_NO ON RELATIONSHIPS(RELATION_DEMOGRAPHIC_NO);
...
CREATE TABLE ENCOUNTERFORM (
  ...
  CONSTRAINT ENCOUNTERFORM_PL PRIMARY KEY  (FORM_VALUE)
);

DROP TABLE MESSAGELISTTBL;
CREATE TABLE MESSAGELISTTBL (
  MESSAGE NUMBER(9) DEFAULT NULL,
  PROVIDER_NO VARCHAR(6) DEFAULT NULL,
  STATUS VARCHAR(10) DEFAULT NULL,
  REMOTELOCATION NUMBER(10) DEFAULT NULL
);
...
CREATE TABLE MESSAGETBL (
  ...
  SENTBYLOCATION NUMBER(10) DEFAULT NULL,
  ATTACHMENT CLOB,
  PDFATTACHMENT BLOB,
...
DROP TABLE MSGDEMOMAP;
CREATE TABLE MSGDEMOMAP (
  MESSAGEID NUMBER(9),
  DEMOGRAPHIC_NO NUMBER(10),
  CONSTRAINT MSGDEMOMAP_PK PRIMARY KEY  (MESSAGEID, DEMOGRAPHIC_NO)
);

DROP TABLE WAITINGLISTNAME CASCADE CONSTRAINTS;
CREATE TABLE WAITINGLISTNAME(
  ...
  CONSTRAINT WAITINGLISTNAME_PK PRIMARY KEY (ID)
);
  
DROP TABLE WAITINGLIST CASCADE CONSTRAINTS;
...
CREATE INDEX WAITINGLIST_LISTID_INDEX ON WAITINGLIST (LISTID);
...
CREATE TABLE RELATIONSHIPS (
  ...
  CREATION_DATE DATE,
  CREATOR VARCHAR2(6),
  SUB_DECISION_MAKER CHAR(1),
  EMERGENCY_CONTACT CHAR(1),
  NOTES CLOB,
  DELETED CHAR(1),
  CONSTRAINT RELATIONSHIPS_PK PRIMARY KEY (ID)
);
...
DROP TABLE ECHART CASCADE CONSTRAINT;
CREATE TABLE ECHART (
  ECHARTID NUMBER(15),
  ECHARTTIMESTAMP TIMESTAMP,
  DEMOGRAPHICNO NUMBER(10),
  PROVIDERNO VARCHAR2(10),
  ...
  REMINDERS CLOB,
  ENCOUNTER CLOB,
  CONSTRAINT ECHART_PK PRIMARY KEY (ECHARTID)
);
CREATE INDEX ECHART_CLIENT_NO_INDEX ON ECHART (DEMOGRAPHICNO);
