...
<%
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"appt_history", "select appointment_no, appointment_date, start_time, remarks, appointment.type,  CONCAT(appointment_date,start_time) AS appttime, end_time, reason, appointment.status, provider.last_name, provider.first_name, appointment.location from appointment LEFT JOIN provider ON appointment.provider_no=provider.provider_no where appointment.demographic_no=? "+ orderby + " desc "},
