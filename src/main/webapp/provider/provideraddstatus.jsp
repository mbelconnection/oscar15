...
<%
  //if action is good, then give me the result
    ...
    if (rowsAffected == 1) {//add_record
      ...
      String displaypage="providercontrol.jsp?year="+request.getParameter("year")+"&month="+request.getParameter("month")+"&day="+request.getParameter("day") +"&view="+  strView  +"&displaymode=day&dboperation=searchappointmentday&x="+request.getParameter("x")+"&y="+request.getParameter("y");
