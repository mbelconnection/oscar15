...
angular.module("noteServices", [])
	.service("noteService", function ($http,$q,$log) {
		return {
		apiPath:'/oscar/ws/rs/notes',
		configHeaders: {headers: {"Content-Type": "application/json","Accept":"application/json"}},
		configHeadersWithCache: {headers: {"Content-Type": "application/json","Accept":"application/json"},cache: true},
        getAllNotes: function(demographicNo){
        	var deferred = $q.defer();
        	 $http.get(this.apiPath+'/'+demographicNo+'/all?numToReturn=200',this.configHeaders).success(function(data){
            	console.log(data);
