...
var providersDB = [
	{name: "Dr. Oscardoc", id: "1", flipdata: {}},
	{name: "Dr. Doe", id: "2"},
	{name: "Dr. Hilts", id: "3"},
	{name: "Dr. Yarwick", id: "4"},
	{name: "Michelle Dietician", id: "5"},
	{name: "Alison Smith", id: "6"},
	{name: "Rand Paul", id: "7"},
	{name: "Michelle Terry", id: "8"}
];
...
var eventsDB = [{"doc_id":"1","patient_name":"John","from_time":"8:00", "duration":"15", "appoint_status":"DP", "is_critical":"Y", "go_to":"E", "reason":"Physical Examination.", "notes":"Noted complications since last year"},
			  {"doc_id":"1","patient_name":"Anderson","from_time":"9:00", "duration":"30", "appoint_status":"CX", "is_critical":"N", "go_to":"E", "reason":"Physical Examination.required check up. need to check the alignmen.", "notes":"Noted complications since last year"},
			  {"doc_id":"3","patient_name":"Leo","from_time":"10:00", "duration":"75", "appoint_status":"CX", "is_critical":"N", "go_to":null, "reason":"Physical Examination", "notes":"Noted complications since last year"}
...
Schedular.prototype.init = function(view){
	...
	this.loadDayEvents(eventsDB);
}

Schedular.prototype.getProvider = function(providerID){
	for(var i=0; i<providersDB.length; i++){
		if(providersDB[i].id == providerID){
			return providersDB[i];
		}
	}
...
Schedular.prototype.getXScale = function(){
	...
	while(_shour < Schedular.config.end_time){
		...
		_smin += Schedular.config.increment; 
		for(var i=0; i<this.persons.length; i++){
			_XScale += '<td style="height:25px !important;width:220px !important;" class="'+style+'" position="'+i+'" ondblclick="sch.addEvent(this)" onclick="sch.deleteEvent(this)" hour="'+_shour+'" min="'+temp_min+'" time="'+time+'" name="'+this.persons[i].name+'" pid="'+this.persons[i].id+'" id="'+this.persons[i].id+'_'+time+'"><img src="images/closebox.png" id="apptCloseBtn" style="display:inline-block;"></img><div /></td>';
		}
