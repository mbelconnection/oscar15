		...
		<h3>Add New Record</h3>
			<form class="form-horizontal" role="form" name="newDemographic">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="Year" ng-model="demographic.yearOfBirth" required>
			    </div>
			    <div class="col-sm-2">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="Month" ng-model="demographic.monthOfBirth" required>
			    </div>
			    <div class="col-sm-2">
			      <input type="text" class="form-control" id="inputPassword3" placeholder="Day" ng-model="demographic.dayOfBirth" required>
			    </div>
