...
<table style="width:100%;">
	...
	<%
		oscar.login.DBHelp dbhelp = new oscar.login.DBHelp();
		java.sql.ResultSet rs = dbhelp.searchDBRecord("select cust3 from demographiccust where demographic_no=" + currentDemographic.getDemographicNo());
		if(rs.next()) {
			String alert = rs.getString("cust3");
