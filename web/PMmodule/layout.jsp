...
<html:html locale="true">
    <head>
        <title>CAISI Shelter Management Information System</title>
        <style type="text/css">
        ...
        <script type="text/javascript">
            var djConfig = {
                isDebug: false,
                parseWidgets: false,
                searchIds: ["addPopupTimePicker", "popupDatePicker", "programClientManagerButton", "caseManagementButton", "masterFileButton"]
            };
        </script>
