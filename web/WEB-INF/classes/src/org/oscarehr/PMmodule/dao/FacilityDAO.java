...
public class FacilityDAO extends HibernateDaoSupport {
    ...
    public List<Facility> getFacilitiesForAgency(Integer agencyId) {
        String query = "from Facility f where f.agencyId = ?";
        return getHibernateTemplate().find(query, new Object[] { agencyId });
    }
