    ...
    public int doStartTag() throws JspException    {
       ...
       if (demoNo != null && !demoNo.equalsIgnoreCase("") && !demoNo.equalsIgnoreCase("null")){
           try {
              ...
              String sql = "select * from appointment where rownum=1 and demographic_no = '"+demoNo+"' and status not like '%C%' and appointment_date >= (select to_char(sysdate,'dd-mon-yyyy hh24:mi:ss') from dual) ";
