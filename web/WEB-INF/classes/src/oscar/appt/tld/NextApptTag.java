    ...
    public int doStartTag() throws JspException    {
       ...
       if (demoNo != null && !demoNo.equalsIgnoreCase("") && !demoNo.equalsIgnoreCase("null")){
           try {
              ...
              String sql = "select * from appointment where demographic_no = '"+demoNo+"' and status not like '%C%' and appointment_date >= sysdate() order by appointment_date where rownum = 1";
