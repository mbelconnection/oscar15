...
public class ProviderDao extends OscarSuperDao {
	...
	private String [][] dbQueries = new String[][] { 
			...
			{"searchappointmentdayprogram", "select appointment_no,provider_no, start_time,end_time,name,demographic_no,reason,notes,status,program_id from appointment where program_id=? and provider_no=? and appointment_date=? order by start_time, status desc "},
