	...
	public Properties getFormRecord(int demographicNo, int existingID)
        ...
        if(existingID <= 0) {
            ...
            if(rs.next()) {
                ...
                props.setProperty("MothersName", db.getString(rs,"last_name") + ", " + db.getString(rs,"first_name"));
            ...
            if (rs.next()) {
                ...
                props.setProperty("c_phone_cur", db.getString(rs,"phone") + "  " + db.getString(rs,"phone2"));
            }
        }
