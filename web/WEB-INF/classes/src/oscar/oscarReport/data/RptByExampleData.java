...
public class RptByExampleData {
    ...
    public String exampleReportGenerate(String sql, Properties oscarVariables) {
        ...
        try {
            ...
            rs = accessDB.queryResults(c, this.sql);
    ...
    public static String replaceSQLString(String oldString, String newString, String inputString) {

        String outputString = "";
        int i;
        for (i = 0; i < inputString.length(); i++) {
            if (!(inputString.regionMatches(true, i, oldString, 0, oldString.length()))) outputString += inputString.charAt(i);
            else {
