...
public final class RptReportCreator {
    ...
    public String getWhereJoinClause(String tableName, boolean bDemo) throws SQLException {
        String ret = "";
        if (bDemo) ret = tableName + ".demographic_no=demographic.demographic_no";
        return ret;
    }
    ...
    public static boolean isIncludeDemo(String value) throws SQLException {
        boolean ret = false;
        if (value.indexOf("demographic.") >= 0) ret = true;
        return ret;
    }
            ...
            while (rs.next()) {
                ...
                for (int i = 0; i < vecFieldName.size(); i++) {
                    try {
                        ...
                        // vecFieldName.get(i));
                        prop.setProperty((String)vecFieldName.get(i), rs.getString((String)vecFieldName.get(i)) == null?"":rs.getString((String)vecFieldName.get(i)));
                    }
