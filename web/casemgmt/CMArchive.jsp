...
<div class="tabs" id="tabs">
    <table cellpadding="3" cellspacing="0" border="0">
        <tr>
            <th title="Admitted"><html:link action="/CaseManagementClientList?method=list">Admitted</html:link></th>
            <th style="background-color: #555; color: #fff;"  title="Discharged">Discharged (archive)</th>
        </tr>
    </table>
</div>
<html:form action="/CaseManagementClientList" >
    <html:hidden property="method" value="archive"/>
    <label>Show clients discharged from:</label>&nbsp;
