	...
	<tr>
		...
		<table cellpadding="0" cellspacing="2"
			...
			<tr>
				...
				<div class="DivCCBreadCrumbs"><a href="SearchDrug3.jsp"> <bean:message key="SearchDrug.title" /></a> > <bean:message key="SelectPharmacy.title" /></div>
				</td>
			</tr>
			<!----Start new rows here-->
			<tr>
			...
			<tr>
				...
				<div class="DivContentSectionHead"><a
					href="ManagePharmacy2.jsp?type=Add"><bean:message
