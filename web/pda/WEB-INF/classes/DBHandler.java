...
public class DBHandler  { 
  ...
  PreparedStatement pstmt = null;
	...
	//Logger lg;
	public DBHandler(String dbDriver,String dbName, String dbUser,String dbPwd,
    String [] qNames,String [] qVals) throws SQLException{
    //lg=new Logger();
    initDBHandler(dbDriver,dbName,dbUser,dbPwd,qNames,qVals,null);
  }
  public DBHandler(String dbDriver,String dbName, String dbUser,String dbPwd,
    String [] qNames,String [] qVals, String [] qTypes) throws SQLException{
    //lg=new Logger();
    initDBHandler(dbDriver,dbName,dbUser,dbPwd,qNames,qVals,qTypes);
  }

  public void initDBHandler(String dbDriver,String dbName, String dbUser,String dbPwd,
    String [] qNames,String [] qVals,String[] qTypes) throws SQLException{
    driverName=dbDriver;
    dbUrl=dbName;
