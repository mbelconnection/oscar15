...
<%
  ...
  String [][] dbQueries=new String[][] {
    ...
    {"save_document","insert into document (doctype, docdesc, docxml, docfilename, doccreator, updatedatetime, status) values(?,?,?,?,?,?,?)"},
     {"save_tickler","insert into tickler (tickler_no,demographic_no, message, status, update_date, service_date, creator, priority, task_assigned_to) values(HIBERNATE_SEQUENCE.nextval,?,?,?,?,?,?,?,?)"},
